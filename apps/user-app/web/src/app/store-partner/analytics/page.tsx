      ...
      <div className="p-4 space-y-6">
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <button 
              onClick={() => router.push('/store-partner/analytics/sales-revenue')}
            ...
            <button 
              onClick={() => router.push('/store-partner/analytics/orders')}
              className="w-full flex items-center justify-between p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors"
            >
              <div className="flex items-center gap-3">
            ...
            <button 
              onClick={() => router.push('/store-partner/analytics/products')}
              className="w-full flex items-center justify-between p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors"
            >
              <div className="flex items-center gap-3">
            ...
            <button 
              onClick={() => router.push('/store-partner/analytics/customers')}
              className="w-full flex items-center justify-between p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors"
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600">
            ...
            <button 
              onClick={() => router.push('/store-partner/finance')}
              className="w-full flex items-center justify-between p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors"
            >
              <div className="flex items-center gap-3">
            ...
            <button 
              onClick={() => router.push('/store-partner/analytics/export')}
