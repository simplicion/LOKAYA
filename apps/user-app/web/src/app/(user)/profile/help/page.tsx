...
const FAQ_ITEMS = [
  {
    ...
    a: 'You can track your orders in real-time by going to Profile > My Orders > Track Order. You will see whether the store has confirmed, packed, or dispatched your parcel.'
  },
  {
          ...
          <form onSubmit={handleSubmitTicket} className="bg-white rounded-3xl p-5 border border-[#E5E2DC] shadow-xs space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-[#171717] flex justify-between">
                ...
                <span className="text-[11px] font-normal text-[#6B6B6B]">Optional</span>
              </label>
              <input
                type="text"
                placeholder="e.g. ORD-93821"
                value={orderId}
