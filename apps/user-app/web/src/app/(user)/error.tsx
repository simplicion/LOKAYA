...
export default function UserAreaError({
  ...
  return (
    <div className="min-h-[85vh] bg-[#FAF9F6] flex flex-col items-center justify-center p-6 text-center max-w-md mx-auto">
      ...
      <h2 className="text-xl font-black text-gray-900 mb-1.5">Page could not load</h2>
      <p className="text-xs text-gray-500 max-w-xs leading-relaxed mb-6">
        We had trouble loading this section. Please try again or navigate to the marketplace feed.
      </p>
